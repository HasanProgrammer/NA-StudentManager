...
using Student.Endpoints.API.Extentions.DependencyInjection.Swaggers.Extentions;
using Serilog;
using Student.Endpoints.API.CustomDecorators;
using Student.Endpoints.API.Extentions.DependencyInjection.IdentityServer.Extentions;
using Student.Infra.Data.Sql.Commands.Common;
using Student.Infra.Data.Sql.Queries.Common;
...
namespace Student.Endpoints.API.Extentions;
...
public static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        //QueryDbContext
        builder.Services.AddDbContext<StudentQueryDbContext>(
