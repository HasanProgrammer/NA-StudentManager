...
using Student.Endpoints.API.Extentions.DependencyInjection.Swaggers.Filters;
using Student.Endpoints.API.Extentions.DependencyInjection.Swaggers.Options;
using Swashbuckle.AspNetCore.SwaggerUI;

namespace Student.Endpoints.API.Extentions.DependencyInjection.Swaggers.Extentions;
