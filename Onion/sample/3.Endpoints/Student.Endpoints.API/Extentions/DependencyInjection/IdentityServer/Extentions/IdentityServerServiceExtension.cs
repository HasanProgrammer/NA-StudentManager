using Student.Endpoints.API.Extentions.DependencyInjection.IdentityServer.Options;

namespace Student.Endpoints.API.Extentions.DependencyInjection.IdentityServer.Extentions;
